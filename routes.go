...
func Routes(router *gin.Engine) {
	...
	v1 := router.Group("/v1")
	{
		...
		v1.GET("/payment-effective-total-last-months", middlewares.Auth, controllers.PaymentEffectiveTotalLastMonth)
		v1.GET("/payment-efficients", middlewares.Auth, controllers.PaymentEfficient)
		v1.GET("/payment-efficient-total-last-months", middlewares.Auth, controllers.PaymentEfficientTotalLastMonth)
